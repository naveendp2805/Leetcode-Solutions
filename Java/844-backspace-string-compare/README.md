...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/backspace-string-compare/)
...
**My Solution:** [844-Backspace-String-Compare.java](./844-Backspace-String-Compare.java)
